#import "DmcaPolicyViewController.h"
#import "MyConstant.h"

@implementation DmcaPolicyViewController
...
- (void)viewDidLoad {
    @try {
        ...
        // load web view
        //
        NSString* strMemberGuidelinesPolicy = [NSString stringWithFormat:@"%@dmca", [MyConstant getPOLICY_URL]];
