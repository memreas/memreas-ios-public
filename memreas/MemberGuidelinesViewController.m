#import "MemberGuidelinesViewController.h"
#import "MyConstant.h"
#import "MIOSDeviceDetails.h"

@implementation MemberGuidelinesViewController
...
- (void)viewDidLoad {
    @try {
        ...
        // load web view
        //
        NSString* strMemberGuidelinesPolicy = [NSString stringWithFormat:@"%@member", [MyConstant getPOLICY_URL]];
