...
+ (NSDictionary *)dictionaryForXMLData:(NSData *)data error:(NSError **)error
{
    ...
    NSDictionary *rootDictionary = [reader objectWithData:data options:0 andXMLParser:nil];
...
{
    XMLReader *reader = [[XMLReader alloc] initWithError:error];
    NSDictionary *rootDictionary = [reader objectWithData:data options:options  andXMLParser:nil];
    return rootDictionary;
}
...
- (NSDictionary *)objectWithData:(NSData *)data options:(XMLReaderOptions)options andXMLParser:(NSXMLParser*)parser
{
